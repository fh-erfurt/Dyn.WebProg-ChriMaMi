...
-- -----------------------------------------------------
-- Table `HORSCH_DB`.`address`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `HORSCH_DB`.`address` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `HORSCH_DB`.`orders_has_address`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `HORSCH_DB`.`orders_has_address` (
  `orders_id` INT NOT NULL,
  ...
  CONSTRAINT `fk_orders_has_address_address1`
    ...
    REFERENCES `HORSCH_DB`.`address` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
