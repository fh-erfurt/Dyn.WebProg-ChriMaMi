...
START TRANSACTION;
USE `HORSCH_DB`;
INSERT INTO `HORSCH_DB`.`orders_has_products` (`id`, `orders_id`, `products_id`, `amount`, `price`) VALUES (DEFAULT, 1, 2, 1, 1000);
INSERT INTO `HORSCH_DB`.`orders_has_products` (`id`, `orders_id`, `products_id`, `amount`, `price`) VALUES (DEFAULT, 2, 4, 1, 1200);
INSERT INTO `HORSCH_DB`.`orders_has_products` (`id`, `orders_id`, `products_id`, `amount`, `price`) VALUES (DEFAULT, 3, 3, 2, 3000);
INSERT INTO `HORSCH_DB`.`orders_has_products` (`id`, `orders_id`, `products_id`, `amount`, `price`) VALUES (DEFAULT, 4, 5, 1, 2500);
INSERT INTO `HORSCH_DB`.`orders_has_products` (`id`, `orders_id`, `products_id`, `amount`, `price`) VALUES (DEFAULT, 5, 2, 1, 2000);
