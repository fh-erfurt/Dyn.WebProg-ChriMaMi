...
INSERT INTO `HORSCH_DB`.`members` (`id`, `email`, `password_hash`, `roll`, `firstname`, `lastname`, `gender`, `phone`, `addresses_id`) VALUES (4, 'christoph.frischmuth@fh-erfurt.de', '$2y$10$f.qa61mbJdKxCpQM2K.bweflRXb.hOmr5PGmtHRWiS1LL4EKgT17y', 'amdin', 'Christoph', 'Frischmuth', 'm', '05498-654132', 1);
