...
<section class="newsContent">
    <article>
        <h2>WM 2022 in Katar Stadionbau geht voran</h2>
        <img src="<?= ASSETSPATH . 'images' . DIRECTORY_SEPARATOR. 'news_main_article.jpg' ?>"/>
    ...
    <aside>
        <section>
            <h2>derzeitge Großprojekte</h2>
            <ul>
                <li>Drei-Schluchten-Staudamm</li>
                <li>Danyang-Kunshan Brücke</li>
                <li>Strahov Stadion</li>
            </ul>
        </section>
        <section>
            <h2>2021 wird unser Jahr</h2>
            <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr,  sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr,  sed diam nonumy am erat, sed diam voluptua.</p>
        </section>
        <section>
            <h2>unsere Partner</h2>
            <ul>
                <li>T&P Architekten und Ingenieure</li>
                <li>Schmidt+Partner</li>
                <li>TIETGE Beratende Ingenieure</li>
                <li>Angermeier AG</li>
                <li>cradletocradle</li>
            </ul>
        </section>
    </aside>
</section>
